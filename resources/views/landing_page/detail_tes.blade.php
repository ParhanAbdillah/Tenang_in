<x-guest-layout>
    <div class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <img src="{{ asset('storage/' . $tes->image) }}" class="w-64 h-64 mx-auto rounded-3xl object-cover mb-8 shadow-lg">

            <h1 class="text-4xl font-bold text-[#0A4D68] mb-4">{{ $tes->nama_tes }}</h1>

            <div class="text-gray-600 leading-relaxed mb-10 max-w-2xl mx-auto">
                {{ $tes->deskripsi_lengkap ?? $tes->deskripsi }}
            </div>
